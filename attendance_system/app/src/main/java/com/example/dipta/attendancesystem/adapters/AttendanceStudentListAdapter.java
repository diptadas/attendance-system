...
public class AttendanceStudentListAdapter extends BaseAdapter {
    ...
    public AttendanceStudentListAdapter(Activity activity, ArrayList<HashMap<String, String>> data) {
