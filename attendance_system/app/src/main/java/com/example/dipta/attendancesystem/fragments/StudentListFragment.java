...
import com.example.dipta.attendancesystem.adapters.StudentListAdapter;
...
public class StudentListFragment extends Fragment implements AsyncTaskQuery.OnAsyncCompletedListener {
    ...
    public void onAsyncCompleted(String taskID, int success, ArrayList<String> keyList, ArrayList<HashMap<String, String>> dataList) {
        ...
        if (taskID.equals("my_task")) {
            ...
            if (success == 0)
                ...
                listView.setAdapter(new StudentListAdapter(getActivity(), dataList));
        }
    }
